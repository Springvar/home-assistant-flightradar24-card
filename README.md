...
| `flight_status`         | Template for displaying flight status information like altitude, speed, and heading.        | `<div>${[tpl.alt_info, tpl.spd_info, tpl.hdg_info].filter((el) => el).join(" - ")}</div>`                                                                                                                                                                                                                    |
